...
const songAddedAction = (roomName, song) => ({
  type: "SONG_ADDED",
  payload: {
    roomnName,
    song
...
const prevPressedAction = {
  type: "PREV_PRESSED",
  payload: "Previous button pressed",
};

const nextPressedAction = {
  type: "NEXT_PRESSED",
...
const playlistReducer = (state, action) => {
  switch (action.type) {
    ...
    //   return {
    //     ...rooms,
    //     [roomName].playInfo.playlist = song;
    //   };

    // }
    case "PLAY_PRESSED": {
      return {
        isPlaying: state.rooms[roomName].playInfo.isPlaying = true,
      };
    }
    case "PAUSE_PRESSED": {
      return {
        isPlaying: state.rooms[roomName].playInfo.isPlaying = false,
      };
    }
    case "PREV_PRESSED": {
      return {
